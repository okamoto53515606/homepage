...
セットアップ画面は配布用 WSL イメージを起動すると `http://localhost:3001` で開きます。WSL イメージの作り方・受け取り方は [docs/wsl.md](./wsl.md) と [homepage-v2-installer](https://github.com/okamoto53515606/homepage-v2-installer) を参照してください。
